...
<?php wp_head(); ?>
<style type="text/css">
	#main-nav, .cat-box-content, #sidebar .widget-container, .post-listing{border-bottom-color:transparent;}
</style>
</head>
<?php global $is_IE ?>
...
<?php } ?>
			...
			<div class="ads-top buscador_redes">
				<div class="redesSociales">
					<a href="https://www.youtube.com/channel/UCCMd5yCRXMm4uYum5ed9zrA" target="_blank">
						<img src="<?php echo home_url(); ?>/wp-content/themes/planH/images/youtube.png" alt="youtube" style="margin-left:55px;">
					</a>
					<a href="https://twitter.com/JulioLaveriano" target="_blank">
						<img src="<?php echo home_url(); ?>/wp-content/themes/planH/images/twitter.png" alt="twitter">
					</a>
					<a href="https://www.facebook.com/pages/Plan-H/546598618773511" target="_blank">
						<img src="<?php echo home_url(); ?>/wp-content/themes/planH/images/facebook.png" alt="facebook">
					</a>
				</div>
				<div class="buscador">
					<div class="search-block">
						<form method="get" id="searchform-header" action="http://planhperu.com/">
